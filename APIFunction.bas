...
Public Function SetHotKey()
    ...
    SetWindowLong Form1.hwnd, GWL_WNDPROC, AddressOf Keywndproc '设置黏贴回调
    '=========
    RegisterHotKey Form1.hwnd, 1, MOD_CONTROL, vbKey1 '注册热键
    RegisterHotKey Form1.hwnd, 2, MOD_CONTROL, vbKey2 '注册热键
    RegisterHotKey Form1.hwnd, 3, MOD_CONTROL, vbKey3 '注册热键
    RegisterHotKey Form1.hwnd, 4, MOD_CONTROL, vbKey4 '注册热键
    RegisterHotKey Form1.hwnd, 5, MOD_CONTROL, vbKey5 '注册热键
    '=========
    '这里还可以添加
End Function
